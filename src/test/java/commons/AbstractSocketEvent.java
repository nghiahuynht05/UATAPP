        ...
        socket.on( Socket.EVENT_CONNECT, new Emitter.Listener() {
            ...
            public void call(Object... objects) {
                ...
                try {
                    phone.put( "number", table.get( 8 ) );
                    phone.put( "country", table.get( 9 ) );
                    params.put( "platform", table.get( 13 ) );
                    params.put( "phone", phone );
                    params.put( "fleetId", table.get( 12 ) );
                    params.put( "appType", table.get( 14 ) );
                    params.put( "verifyCode", table.get( 11 ) );
                    params.put( "ime", table.get( 10 ) );
                    params.put( "password", table.get( 15 ) );
            ...
            public void call(Object... objects) {
                JSONObject response = (JSONObject) objects[0];
                LOGGER.info( "Event: 'register': {}", response );
                values.offer( objects );
            }
        } );
        socket.connect();
